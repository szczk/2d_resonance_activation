...
module add gcc/4.8.0
# module add fftw
module add gsl
#module add libs/glibc/2.7

./generator.x --alpha ${alpha} --noise ${sigma} --storage "$SCRATCH"  --tmp "$SCRATCH" --prefix "escape" --data_file_num ${num}  > $logs/escape_2d_a${alpha}_s${sigma}_n${num}.log
